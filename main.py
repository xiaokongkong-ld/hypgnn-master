...
def parse_default_args():
    ...
    parser.add_argument('--task', type=str, default='proteins', choices=['qm8',
                                                     'qm9',
                                                     'zinc',
                                                     'ethereum',
                                                     'node_classification',
    ...
    parser.add_argument("--distributed_method", default='multi_gpu', choices=['multi_gpu', 'slurm', 'cuda:0'])
    ...
    if args.task != 'node_classification':
        ...
        # elif args.distributed_method == 'cpu':
